  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated accommodation on the ground floor, subject to availability. You'll enjoy a comfortable two-bedroom apartment that offers a true city living experience. The price quoted is for two guests — please specify the number of guests at the time of booking to receive an exact price for larger groups.</p>
      </div>
      
      {/* Host Information */}
      <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9GXb6s2-MaZFimiAszBkTgXVTsAJk0WqkCw&s" alt='Host' className='w-14 h-14 md:h-18 md:w-18 rounded-full'/>
          <div>
